...
<head>
    ...
    <link rel="sylesheet" href="<?= base_url('assets/'); ?>assets/user/css/bootstrap.css">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <?php } ?>
                    <span class="nav-item nav-link nav-right" style="display:block; margin-left:20px;">Selamat Datang <b><?= $user; ?></br></span>
                </div>
            </div>
        </div>
    </nav>
